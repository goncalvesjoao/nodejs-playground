...
describe('V4', () => {
  test('child class should be able to populate values from parent class', () => {
    ...
    class ProjectsRepository {
      static defaultInput() {
        return { projectDbRows: [] as Project[] };
      }

      protected projectDbRows: Project[];

      constructor(
        context?: Partial<ReturnType<typeof ProjectsRepository.defaultInput>>,
      ) {
        const data = {
        ...
        this.projectDbRows = data.projectDbRows;
      }
    ...
    class ProjectsService {
      ...
      constructor(
        context?: Partial<ReturnType<typeof ProjectsService.defaultInput>>,
      ) {
    ...
    class PagesRepository {
      ...
      constructor(
        context?: Partial<ReturnType<typeof PagesRepository.defaultInput>>,
      ) {
        const data = { ...PagesRepository.defaultInput(), ...(context || {}) };

        this.pageDbRows = data.pageDbRows;
      }
    ...
    class PagesService {
      ...
      constructor(
        context?: Partial<ReturnType<typeof PagesService.defaultInput>>,
      ) {
    ...
    class PagesDeployService extends PagesService {
      ...
      constructor(
        context?: Partial<ReturnType<typeof PagesDeployService.defaultInput>>,
      ) {
        super(context);
        const data = {
    ...
    class ProjectsDeployService extends ProjectsService {
      ...
      constructor(
        context?: Partial<
          ReturnType<typeof ProjectsDeployService.defaultInput>
        >,
      ) {
        super(context);
        const data = {
